...
import UserDefinitions from "../plugin/user-definitions";
...
import RecordProgress from "../plugin/record-progress";
import Image from "../plugin/image";
import TextToSpeech from "../plugin/text-to-speech";
import { IStudentInfo } from "../../types";
import { isAudioUrl, getAudio, isAudioOrRecordingUrl } from "../../utils/audio";
import LanguageSelector, { ILanguage } from "../plugin/language-selector";

import * as icons from "../common/icons.scss";
import * as css from "../plugin/glossary-popup.scss";
...
export default class ModelAuthoringGlossaryPopup extends React.Component<IProps, IState> {
  ...
  public componentDidUpdate(prevProps: IProps) {
    if (prevProps.askForUserDefinition !== this.props.askForUserDefinition){
      this.setState({questionVisible: this.props.askForUserDefinition})
    }
  }
  ...
  public render() {
    ...
    const { enableStudentLanguageSwitching, languages, onLanguageChange } = this.props;
    return (
      <div className={css.glossaryPopup}>
        {enableStudentLanguageSwitching &&
        <LanguageSelector
          languages={languages}
    ...
    return (
      <div>
        <Definition
          ...
          imageUrl={autoShowMedia ? imageUrl : ""}
